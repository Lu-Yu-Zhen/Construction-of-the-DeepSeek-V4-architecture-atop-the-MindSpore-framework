...
本代码仓库系依据 DeepSeek-V4 技术报告所衍生的独立研究项目，严格限定于学术探索与知识学习之范畴。项目的核心目标在于架构层面的概念验证，明确排除了针对特定硬件的算子级优化、分布式训练策略及推理加速等生产级工程实践。

因此，本仓库所呈现的实现细节与性能数据，既非官方认可的标准方案，亦不可作为官方模型性能的参考依据。
